...
bool offset_index_group_add_offset(multi_heap_handle_t heap, offset_index_group_t* group, size_t offset, bool again)
{
...
bool offset_index_group_remove_offset(multi_heap_handle_t heap, offset_index_group_t* group, size_t offset)
{
if(cluster_group_get_level(group)==0)
...
size_t offset_index_group_remove_offset_at(multi_heap_handle_t heap, offset_index_group_t* group, size_t at)
{
...
offset_index_item_group_t* offset_index_item_group_create(multi_heap_handle_t heap)
{
offset_index_item_group_t* group=(offset_index_item_group_t*)multi_heap_alloc_internal(heap, sizeof(offset_index_item_group_t));
if(group==NULL)
	return NULL;
...
MULTI_HEAP_ASSERT(child_count>0);
...
MULTI_HEAP_ASSERT(!exists);
uint16_t child_count=cluster_group_get_child_count((cluster_group_t*)group);
if(child_count==CONFIG_CLUSTER_GROUP_SIZE)
	return false;
...
{
uint16_t child_count=cluster_group_get_child_count((cluster_group_t*)group);
MULTI_HEAP_ASSERT(child_count+count<=CONFIG_CLUSTER_GROUP_SIZE);
...
{
uint16_t child_count=cluster_group_get_child_count((cluster_group_t*)group);
MULTI_HEAP_ASSERT(at+count<=child_count);
...
offset_index_parent_group_t* offset_index_parent_group_create(multi_heap_handle_t heap, uint16_t level)
{
offset_index_parent_group_t* group=(offset_index_parent_group_t*)multi_heap_alloc_internal(heap, sizeof(offset_index_parent_group_t));
if(group==NULL)
	return NULL;
...
offset_index_parent_group_t* offset_index_parent_group_create_with_child(multi_heap_handle_t heap, offset_index_group_t* child)
{
offset_index_parent_group_t* group=(offset_index_parent_group_t*)multi_heap_alloc_internal(heap, sizeof(offset_index_parent_group_t));
if(group==NULL)
	return NULL;
...
bool offset_index_parent_group_add_offset(multi_heap_handle_t heap, offset_index_parent_group_t* group, size_t offset, bool again)
{
...
bool offset_index_parent_group_add_offset_internal(multi_heap_handle_t heap, offset_index_parent_group_t* group, size_t offset, bool again)
{
uint16_t pos=0;
...
bool offset_index_parent_group_combine_child(multi_heap_handle_t heap, offset_index_parent_group_t* group, uint16_t at)
{
...
if(at>0)
	...
	if(count+before<=CONFIG_CLUSTER_GROUP_SIZE)
		{
...
if(at+1<child_count)
	...
	if(count+after<=CONFIG_CLUSTER_GROUP_SIZE)
		{
...
bool offset_index_parent_group_combine_children(multi_heap_handle_t heap, offset_index_parent_group_t* group)
{
bool combined=false;
uint16_t child_count=cluster_group_get_child_count((cluster_group_t*)group);
...
bool offset_index_parent_group_remove_offset(multi_heap_handle_t heap, offset_index_parent_group_t* group, size_t offset)
{
uint16_t pos=0;
uint16_t count=offset_index_parent_group_get_item_pos(group, offset, &pos, true);
MULTI_HEAP_ASSERT(count==1);
if(count!=1)
	return false;
...
size_t offset_index_parent_group_remove_offset_at(multi_heap_handle_t heap, offset_index_parent_group_t* group, size_t at, bool passive)
{
uint16_t pos=parent_group_get_group((parent_group_t*)group, &at);
MULTI_HEAP_ASSERT(pos<CONFIG_CLUSTER_GROUP_SIZE);
...
bool offset_index_parent_group_split_child(multi_heap_handle_t heap, offset_index_parent_group_t* group, uint16_t at)
{
uint16_t child_count=cluster_group_get_child_count((cluster_group_t*)group);
if(child_count==CONFIG_CLUSTER_GROUP_SIZE)
	return false;
...
bool offset_index_add_offset(multi_heap_handle_t heap, offset_index_t* index, size_t offset)
{
if(!index->root)
	{
...
void offset_index_drop_root(multi_heap_handle_t heap, offset_index_t* index)
{
...
if(level==0)
	...
	if(child_count==0)
		{
		index->root=NULL;
		multi_heap_free_to_cache(heap, root);
		}
	return;
	}
if(child_count>1)
...
bool offset_index_lift_root(multi_heap_handle_t heap, offset_index_t* index)
{
...
void offset_index_remove_offset(multi_heap_handle_t heap, offset_index_t* index, size_t offset)
{
if(offset_index_group_remove_offset(heap, index->root, offset))
	offset_index_drop_root(heap, index);
}

size_t offset_index_remove_offset_at(multi_heap_handle_t heap, offset_index_t* index, size_t at)
{
MULTI_HEAP_ASSERT(index->root);
