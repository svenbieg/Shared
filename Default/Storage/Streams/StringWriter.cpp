...
StringWriter::StringWriter(OutputStream* stream):
pStream(nullptr),
pWriteAnsi(nullptr),
...
UINT StringWriter::Print(LPCSTR value)
{
return DoPrint(pWriteAnsi, 0, value);
}

UINT StringWriter::Print(LPCSTR value, StringFormatFlags flags, UINT width)
{
return DoPrint(value, flags, width);
}

UINT StringWriter::Print(LPCWSTR value)
{
return DoPrint(pWriteUnicode, 0, value);
}

UINT StringWriter::Print(LPCWSTR value, StringFormatFlags flags, UINT width)
{
return DoPrint(value, flags, width);
}

UINT StringWriter::Print(UINT len, LPCSTR value)
{
return DoPrint(pWriteAnsi, len, value);
}

UINT StringWriter::Print(UINT len, LPCWSTR value)
{
return DoPrint(pWriteUnicode, len, value);
}

UINT StringWriter::Print(Handle<String> value)
{
if(!value)
	return 0;
...
UINT StringWriter::Print(LPCSTR str, VariableArguments const& args)
{
UINT written=0;
UINT pos=0;
UINT arg=0;
...
UINT StringWriter::PrintChar(CHAR c, UINT count)
{
return DoPrintChar(pWriteAnsi, c, count);
}

UINT StringWriter::PrintChar(WCHAR c, UINT count)
{
return DoPrintChar(pWriteUnicode, c, count);
}

UINT StringWriter::PrintDouble(DOUBLE value, StringFormatFlags flags, UINT width, UINT prec)
{
CHAR buf[64];
...
UINT StringWriter::PrintFloat(FLOAT value, StringFormatFlags flags, UINT width, UINT prec)
{
CHAR buf[32];
...
UINT StringWriter::PrintHex(UINT value, StringFormatFlags flags, UINT width)
{
CHAR buf[32];
...
UINT StringWriter::PrintHex64(UINT64 value, StringFormatFlags flags, UINT width)
{
CHAR buf[64];
...
UINT StringWriter::PrintInt(INT value, StringFormatFlags flags, UINT width)
{
CHAR buf[32];
...
UINT StringWriter::PrintInt64(INT64 value, StringFormatFlags flags, UINT width)
{
CHAR buf[64];
...
UINT StringWriter::PrintUInt(UINT value, StringFormatFlags flags, UINT width)
{
CHAR buf[32];
...
UINT StringWriter::PrintUInt64(UINT64 value, StringFormatFlags flags, UINT width)
{
CHAR buf[64];
...
VOID StringWriter::SetStream(OutputStream* stream)
{
if(pStream==stream)
	return;
pStream=stream;
...
template <class _func_t, class _char_t> UINT StringWriter::DoPrint(_func_t write_fn, UINT len, _char_t const* value)
{
if(!value)
	return 0;
if(len==0)
...
template <class _char_t> UINT StringWriter::DoPrint(_char_t const* value, StringFormatFlags flags, UINT width)
{
if(!value)
	return 0;
UINT len=0;
...
template <class _func_t, class _char_t> UINT StringWriter::DoPrintChar(_func_t write_fn, _char_t c, UINT count)
{
UINT size=0;
